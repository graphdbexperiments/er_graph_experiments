...
def main():
    ...
    for index in range(len(percentage_to_update)):
        ...
        for i in range(0, runs):
            ...
            activation = f"MATCH (o:ORDERS) WITH o AS ords, rand() AS r ORDER BY r LIMIT {round(amount * percentage_to_update[index])} SET ords:ORDERS:ACTIVATED"
            ...
            index_activation = "CREATE CONSTRAINT activated_orders FOR (a:ACTIVATED) REQUIRE (a.o_orderkey) IS NODE KEY"
