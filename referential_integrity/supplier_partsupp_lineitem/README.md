...
<p align="center" width="100%">
<img src="./images/update_chain_supp_part-poly.png" alt="Validation of update chain starting on SUPPLIER on TPC-H medium" width ="40%"/>
<img src="./images/update_chain_supp_part.png" alt="Validation of update chain starting on SUPPLIER on TPC-H medium" width ="40%"/>
</p>
