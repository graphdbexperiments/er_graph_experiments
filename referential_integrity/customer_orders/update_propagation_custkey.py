...
def main():
    ...
    for index in range(len(percentage_to_update)):
        ...
        for i in range(0, runs):
            ...
            activation = f"MATCH (c:CUSTOMER) WITH c AS custs, rand() AS r ORDER BY r LIMIT {round(amount * percentage_to_update[index])} SET custs:CUSTOMER:ACTIVATED"
            ...
            index_activation = "CREATE CONSTRAINT activated_customer FOR (a:ACTIVATED) REQUIRE (a.c_custkey) IS NODE KEY"
