...
def main():
    ...
    for index in range(len(percentage_to_update)):
        ...
        for i in range(0, runs):
            ...
            activation = f"MATCH (p:PART) WITH p AS parts, rand() AS r ORDER BY r LIMIT {round(amount * percentage_to_update[index])} SET parts:PART:ACTIVATED"
            ...
            index_activation = "CREATE CONSTRAINT activated_part FOR (a:ACTIVATED) REQUIRE (a.p_partkey) IS NODE KEY"
