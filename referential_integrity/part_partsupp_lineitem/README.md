...
<img src="./images/update_chain_small_part_new.png" alt="Validation of update chain starting on PART on TPC-H small" width ="40%"/>
</p>
<ins>Results for TPC-H medium (sf=0.1) shown for time logarithmically scaled:</ins><br>
<p align="center" width="100%">
<img src="./images/update_chain_medium_part_new.png" alt="Validation of update chain starting on PART on TPC-H medium" width ="40%"/>
</p>
<ins>Results for TPC-H large (sf=1) shown for time logarithmically scaled:</ins><br>
<p align="center" width="100%">
<img src="./images/update_chain_large_part_new.png" alt="Validation of update chain starting on PART on TPC-H large" width ="40%"/>
</p>
